...
const communityStorySchema = new mongoose.Schema(
  {
    ...
    region: {
      // User's region, if provided and relevant
      type: String,
      trim: true,
    },
    ...
    reportedCount: {
      // For tracking how many times a story has been reported
      type: Number,
      default: 0,
    },
  },
...
const CommunityStory = mongoose.model("CommunityStory", communityStorySchema, "CommunityStories");
