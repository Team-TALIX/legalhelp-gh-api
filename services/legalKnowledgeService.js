...
export const generateLegalResponse = async (query, language, context = {}) => {
  ...
  if (confidence < 0.2) {
    const defaultResponses = {
      ...
      twi: "Mete aseɛ sɛ worebisa mmara mu nsɛm bi ho. Metumi boa wo wɔ nsɛm a ɛfa ɔhɔhoɔ hokwan, asase ntoatoasoɔ, deɛ wobɛyɛ sɛ wɔkyere wo, awareɛ mu gyaeɛ, adwumayɛfoɔ hokwan, ne deɛ ɛkeka ho. Wobɛtumi aka wo mmara mu asɛm no mu nsɛm akyerɛ me pefee?",
      ewe: "Mese be èle biabiam tso se ŋuti. Mate ŋu akpe ɖe ŋuwò le biabiawo tso xɔdzikpɔlawo ƒe ablɔɖevinyenyewo, anyigba ŋkɔɖoɖo, nu si nàwɔ ne wolé wò, srɔ̃ɖeɖe megbedede ɖoɖo, dɔwɔlawo ƒe ablɔɖevinyenyewo, kple bubuwo ŋu. Àte ŋu agblɔ wò se ƒe biabiawo ƒe nyatakakawo nam?",
      dagbani:
...
export const getUrgentContactMessage = (language) => {
  const messages = {
    ...
    twi: "Sɛ wohia mmoa ntɛm a, frɛ",
    ewe: "Ne èhia kpekpeɖeŋu enumake la, ƒo ka ɖe",
    dagbani: "Ka a bɔri kpakuya ntɛmntɛm, kɔl",
  };
